...
This directory conducts federated instruction tuning with a pretrained [Llama-3.2-3B](https://huggingface.co/meta-llama/Llama-3.2-3B) model on a [Finance dataset](https://huggingface.co/datasets/FinGPT/fingpt-sentiment-train).
...
## Checkpoint download
[Link](https://drive.google.com/drive/folders/1fPhqWJrh4nuSdWxNC5MbNqaiTjg1Jt_p?usp=sharing)
